...
@total_ordering
class CPUUsedMemory(Record):
    """
    The used memory in the CPU.
    """
    ...
    def __add__(self, other):
        ...
        return CPUUsedMemory(value=(self.value() + other.value()))
    ...
    def __sub__(self, other):
        ...
        return CPUUsedMemory(value=(other.value() - self.value()))
