...
@total_ordering
class CPUAvailMemory(Record):
    """
    The available memory in the CPU.
    """

    tag = "cpu_avail_memory"
    ...
    def __add__(self, other):
        ...
        return CPUAvailMemory(value=(self.value() + other.value()))
    ...
    def __sub__(self, other):
        ...
        return CPUAvailMemory(value=(other.value() - self.value()))
